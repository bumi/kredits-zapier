...
module.exports = {
  key: 'contribution_claimed',

  noun: 'Kredits Contribution',
  display: {
    label: 'Kredits Contributions Claimed',
    description: 'Trigger when a Kredits contribution gets claimed.'
  },
  ...
  operation: {
    ...
    perform: (z, bundle) => {
      ...
      return new Kredits(ethProvider, null, options).init().then(async (kredits) => {
        ...
        let event = kredits.Contribution.contract.interface.events.ContributionClaimed;
